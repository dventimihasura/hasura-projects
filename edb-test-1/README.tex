...
\section{Databases}
\label{sec:org57ee5ba}
\subsection{Postgres}
\label{sec:org353d7d7}
\subsection{Schema}
\label{sec:orgde2ac44}
\subsubsection{{\bfseries\sffamily DONE} Table Basics}
\label{sec:orgd78c12c}
\begin{itemize}
