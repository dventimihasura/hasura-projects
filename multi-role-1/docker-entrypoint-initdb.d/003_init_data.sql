...
update account set manager = ((array['hasurauser_1', 'hasurauser_2', 'hasurauser_3', 'hasurauser_4'])[floor(random()*4+1)]);

update "order"
   set manager = account.manager
       from account
 where "order".account_id = account.id;

update order_detail
   set manager = "order".manager
       from "order"
