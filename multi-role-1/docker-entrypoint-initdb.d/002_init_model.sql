...
alter table account add column manager text null;

alter table "order" add column manager text null;

alter table order_detail add column manager text null;
...
create policy manager on account using (manager = current_user);

create policy manager on "order" using (manager = current_user);

create policy manager on order_detail using (manager = current_user);
